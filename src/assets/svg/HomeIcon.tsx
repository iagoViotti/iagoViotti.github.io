  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <path
          d="M12 16.0002C13.6569 16.0002 15 14.6571 15 13.0002C15 11.3434 13.6569 10.0002 12 10.0002C10.3431 10.0002 9 11.3434 9 13.0002C9 14.6571 10.3431 16.0002 12 16.0002Z"
          stroke={stroke}
          strokeWidth="2.4"
          strokeLinecap="round"
          strokeLinejoin="round"
